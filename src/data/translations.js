...
export const translations = {
  en: {
    ...
    museum: {
      ...
      intro3: "Among the collection of objects displayed at Casa de Teresita, you will find tableware, cutlery, glassware, coins, jewelry, watches, stamps, furs, books, paintings, surgical instruments, records, trunks, household items, and decorations. Tell us which objects you recognize and find something that comes from your country.",
      filterBy: "Filter by",
  ...
  es: {
    ...
    museum: {
      ...
      subtitle: "Una colección de artículos históricos, objetos de diferentes lugares del mundo, documentos, libros y fotografías, además de curiosidades que preservan el patrimonio y legado de la familia.",
      ...
      intro1: "La Casa de Teresita alberga una colección notable de objetos que ayudan a entender la historia de Bolivia en el siglo XX. Cada pieza ha sido cuidadosamente preservada por nuestra familia durante más de un siglo.",
      intro2: "Muebles de estilo y dos hermosos pianos engalanan la casa, finamente decorada con artículos provenientes de muchos lugares en el mundo. Escanea los códigos QR para obtener referencia de los objetos más importantes, y se puede solicitar también una visita guiada.",
      intro3: "Entre la colección de objetos que se exponen en Casa de Teresita encontrarás vajillas, cubiertos, cristalería, monedas, joyería, relojes, estampillas, pieles, libros, cuadros, instrumental quirúrgico, discos, baúles, enseres de casa y adornos. Coméntanos qué objetos reconoces y encuentra algo que provenga de tu país.",
      filterBy: "Filtrar por",
